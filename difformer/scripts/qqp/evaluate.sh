...
DATASET="qqp/data-bin"
# MODEL_DIR="models/${DATASET}"
MODEL_DIR="models/Meta_qqp"

OUTPUT_NAME="evaluate_step${STEPS}_beam${LENGTH_BEAM}x${NOISE_BEAM}_${UPDATE}_onlyScheduler"
OUTPUT_DIR=$MODEL_DIR/$OUTPUT_NAME
# OUTPUT_DIR="models/Meta_dinoiser_qqp"/$OUTPUT_NAME
