...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, simi_lambda=None, simi_step=None, simi_penalty=None, simi_noise=None):
        """
        ...
        """
        print("[BG-DiffuSeq training loss]")
        ...
        if simi_penalty == "cosine":
            return terms["cos_penalty"] * tt_mask
        if simi_penalty.startswith("l2"):
            return terms["l2"] * tt_mask
        else:
            print('[ERROR] what kind of simi_penalty?')
            return None
