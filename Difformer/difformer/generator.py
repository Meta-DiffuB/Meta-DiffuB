...
class DifformerGenerator(IterativeRefinementGenerator):
    ...
    def generate(self, models, sample, **kwargs):
        ...
        # with open('models/Meta_dinoiser_wiki/evaluate_step20_beam5x4_100_schedulerQQP/betas.pkl', 'wb') as file:
        #     pickle.dump(betas, file)
        #     print('[save beta]', betas.shape)
        
        # with open('models/Meta_dinoiser_wiki/evaluate_step20_beam5x4_100_schedulerQQP/betas.pkl', 'rb') as file:
        ...
        # with open('models/Meta_qqp/evaluate_step20_beam5x4_100_onlyScheduler/temp50.pkl', 'wb') as file:
        #     pickle.dump(finalized, file)
        
        # with open('models/Meta_qqp/evaluate_step20_beam5x4_100_onlyScheduler/temp50.pkl', 'rb') as file:
        #     finalized = pickle.load(file)
        return finalized
