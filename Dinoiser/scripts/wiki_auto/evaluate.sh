...
MODEL_DIR="models/Meta_dinoiser_wiki"

OUTPUT_NAME="evaluate_step${STEPS}_beam${LENGTH_BEAM}x${NOISE_BEAM}_${UPDATE}_schedulerQQP"
# OUTPUT_DIR=$MODEL_DIR/$OUTPUT_NAME
OUTPUT_DIR="models/Meta_dinoiser_wiki"/$OUTPUT_NAME
